...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        // COMPLETED (16) Within the NumberViewHolder class, create a void method called bind that accepts an
        // int parameter called listIndex
        public void bind(int listIndex) {
            // COMPLETED (17) Within bind, set the text of listItemNumberView to the listIndex
            // COMPLETED (18) Be careful to get the String representation of listIndex, as using setText with
            // an int does something different
